...
export const PortfolioCardData: PortfolioCardProps[] = [
    {
        ...
        logo: 'Globe',
        description: 'This website was made to present frontend skills by using modern frameworks, animations and own design',
    ...
    },
    {
        ...
        logo: 'ToDoList',
        description: 'Make list with tasks and delete them if they are done. The main goal of application is to train Redux Toolkit skills in React Typescript',
     ...
     },
     {
        ...
        logo: 'ToDoList',
        description: 'Make list with tasks and delete them if they are done. The main goal of application is to train Redux skills in React Typescript',
